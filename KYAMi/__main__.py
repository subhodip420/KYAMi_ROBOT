...
from KYAMi.modules import ALL_MODULES
...
from KYAMi.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("KYAMi.modules." + module_name)
